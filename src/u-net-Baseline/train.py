...
logging.basicConfig(filename=os.path.join('logs','log_unet.log'), filemode='a',level=logging.INFO, format='%(name)s - %(levelname)s - %(message)s')
logging.info('*'*10)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', default='checkpoints', help='folder to save checkpoints into')
